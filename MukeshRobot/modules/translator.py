...
TRANSLATE_HANDLER = DisableAbleCommandHandler(["jsjsbjsksbkekbbjxsidhu", "sidhunsbjzbsktl"], totranslate, run_async=True)
...
**ɪғ ʏᴏᴜ ᴡᴀɴᴀ ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ғɪʀsʟʏ ʏᴏᴜ ᴡʟʟ ᴘᴀʏ 100$ ᴏғ ᴍʏ ᴏᴡɴᴇʀ.**
""",
