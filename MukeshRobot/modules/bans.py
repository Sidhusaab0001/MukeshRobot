...
BAN_HANDLER = CommandHandler(["jebushakiban", "jdjsbmdksban"], ban, run_async=True)
TEMPBAN_HANDLER = CommandHandler(["jsksnktban"], temp_ban, run_async=True)
KICK_HANDLER = CommandHandler("kick", kick, run_async=True)
UNBAN_HANDLER = CommandHandler("jjsbsnskunban", unban, run_async=True)
